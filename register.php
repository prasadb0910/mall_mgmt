        ...
        if($_SESSION["otp"]==$_POST["otp"]) {
         //   $first_name=$_SESSION["first_name"];
          //  $last_name=$_SESSION["last_name"];
            ...
            $sql = "insert into contact_master (c_name, c_last_name, c_gid, c_emailid1, c_mobile1, c_status, c_createdate, c_createdby, c_modifieddate, c_modifiedby) 
                    values ('".$first_name."', '".$last_name."', '".$group_id."', '".$email."', '".$mobile."', 'Approved', '".$now."', '0', '".$now."', '0')";
            mysqli_query($conn, $sql);
            ...
            $sql = "insert into group_users (gu_gid,name,gu_email,gu_mobile,gu_password,gu_role,add_date,gu_cid,assigned_status,assigned_role,created_at,created_by,updated_at,updated_by,user_type,isVerified,assure,first_name) 
                    values ('".$group_id."','".$name."','".$email."','".$mobile."','".$password."','Admin','".$now."','".$contact_id."','Approved','1','".$now."','0','".$now."','0','owner','0','1','".$first_name."') ";
 ...
 <div class="login-container lightmode">
    ...
    <form id="form_registration" class="form-horizontal" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" style="<?php if(isset($_SESSION["otp"])) echo 'display: none;'; ?>" autocomplete="off">       
       ...
       <div class="form-group" style="display:none">
        ...
        <p style="font-size:14px;">By Signing Up, you agree to our <a href="terms-and-conditions.html">Terms & Conditions.</a></p>     
