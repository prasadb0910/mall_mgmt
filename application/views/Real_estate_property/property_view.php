		...
		<div class="content ">
			...
			<div class=" container-fluid   container-fixed-lg">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="index.php/Purchase/checkstatus/All">Purchase List</a></li>
						...
						<div class="col-md-9">
							<div class=" container-fluid container-fixed-lg bg-white">
			                    <div class="card card-transparent">
			                                ...
			                                <div class="row clearfix">
			                                    ...
			                                    <div class="col-md-5">
			                                        <div class="form-group form-group-default">
			                                            <label>Owner</label>
			                                          	<span class="label_addr">Dhaval Maru</span>
			                                        </div>
			                                    </div>
			                                </div>
			                        ...
			                        <p class=""><b>General Information</b></p>
			                        <div class="a">
			                            <div class="row clearfix">
			                                <div class="col-md-6">
			                                    <div class="form-group form-group-default">
			                                        <label>Unit Name</label>
			                                   	<span class="label_addr">Rajlaxmi Apartment</span>
			                                    </div>
			                                </div>
										    ...
										    <div class="col-md-6">
			                                    <div class="form-group form-group-default">
			                                        ...
			                                        <span class="label_addr">Basement</span>
			                                    </div>
			                                </div>
			                            ...
			                            <div class="row clearfix">
											...
											<span class="label_addr">123</span>
			                                    </div>
			                                </div>
			                            ...
			                            <div class="row clearfix">
			                                <div class="col-md-6">
			                                    <div class="form-group form-group-default ">
													...
													<span class="label_addr">1,200</span>
			                                    </div>
			                                </div>
			                                <div class="col-md-6">
			                                    <div class="form-group form-group-default ">
			                                        <label class=""> Area Unit </label>
													<span class="label_addr">Sqft</span>
			                                    </div>
			                                </div>
			                            </div>
									...
									<div class="row clearfix">
			                                <div class="col-md-6">
			                                    <div class="form-group form-group-default ">
													...
													<span class="label_addr">1,20,000</span>
			                                    </div>
			                                </div>
			                                <div class="col-md-6">
			                                    <div class="form-group form-group-default ">
			                                        <label class=""> Allocated Maintenance </label>
													<span class="label_addr">12000</span>
			                                    </div>
			                                </div>
			                            </div>
