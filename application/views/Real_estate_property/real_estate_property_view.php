...
<div class="page-container ">
	...
	<div class="page-content-wrapper ">
		<div class="content ">
			<form id="form_purchase_view" role="form" method ="post" action="<?php echo base_url().'index.php/Real_estate_property/update/'.$p_id; ?>" 
								...
								<div class="dropdown pull-right hidden-md-down">
									...
									<div class="dropdown-menu dropdown-menu-right profile-dropdown" role="menu">
										<?php  if(isset($access)) { 
											...
											<a href="<?php echo base_url().'index.php/real_estate_property/edit/'.$p_id; ?>" class="dropdown-item edit" ><i class="pg-settings_small"></i> Edit</a>
										<?php } }  ?>
			                    ...
			                    <div class="card card-transparent">
			                        ...
			                        <div class="a">
			                            ...
			                            <div class="row clearfix">
											...
											<span class="label_addr"><?=$property[0]->unit_no; ?></span>
			                                    </div>
			                                </div>
			                                ...
			                                <div class="col-md-6">
			                                    <div class="form-group form-group-default ">
			                                   	...
			                                   	<span class="label_addr"><?=$property[0]->floor;?></span>
