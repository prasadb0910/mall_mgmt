    ...
    <div class="content ">
        <div class=" container-fluid container-fixed-lg">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Non Real Estate</li>
            </ol>
                                                    ...
                                                    <div class="card card-transparent container-fixed-lg bg-white " style="background:#fff;">
                                                        ...
                                                        <div class="row" style="padding-left:15px;padding-right:15px;">
                                                            ...
                                                            <div class=" col-md-6 leases">
                                                                 <a href="<?php echo base_url().'index.php/accounting/checkstatus/All/0/0/'.$rent[$i]->txn_id; ?>">
                                                        ...
                                                        <div class="col-md-12">
                                                            <a href="<?php echo base_url().'index.php/Rent_non_real_estate/view/'.$rent[$i]->txn_id; ?>" class=" pull-right invoice p-b-5     p-t-5" style="color:#5cb85c;">View <i class="fa fa-angle-right tab-icon"></i> </a>
                                                ...
                                                <div class="card card-transparent container-fixed-lg bg-white " style="background:#fff;">
                                                    <div class="row">
                                                        ...
                                                        <div class="prop_btns">
                                                            ...
                                                            <div class="pull-left" style="margin-top: 40px;padding-left: 15px;">
                                                                <a href="<?php echo base_url().'index.php/accounting/checkstatus/All/0/0/'.$rent[$i]->txn_id; ?>" data-toggle="tooltip" data-placement="bottom" title="Accounting"><i style="font-size:22px;" class="fa fa-inr"></i></a>
                                                            </div>
                                                        </div>
