...
<head>
    ...
    <style>
		...
		#prop_details  .select2-container,#buyer-section .select2-container,#documents .select2-container
		{
			 z-index:0!important;
		}
        /*.modal.fade {
                ...
                <div class=" container-fluid container-fixed-lg bg-white">
                    <div class="card card-transparent">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    <div class="form-group form-group-default ">
                                        ...
                                        <input type="text" class="form-control datepicker" id="sale_date" name="sale_date" placeholder="Enter Here" value="<?php if(isset($s_txn)) { if(count($s_txn)>0) {echo date('d/m/Y',strtotime($s_txn[0]->date_of_sale));}} ?>" />

                                        <input type="hidden" onkeyup="calculateprofit();" class="form-control format_number" name="cost_purchase" id="costpurchase" placeholder="Enter Here" value="<?php if(isset($s_txn)) { if(count($s_txn)>0) { echo format_money($s_txn[0]->cost_of_purchase,2); } else { echo '0'; } } else { echo '0'; } ?>" />
                                        <input type="hidden" name="sales_consideration" id="sales_consideration" value="0" />
                                        <input type="hidden" class="form-control format_number" name="cost_of_acquisition" id="cost_of_acquisition" placeholder="Enter Here"  value="<?php if(isset($s_txn)) { if(count($s_txn)>0) { echo format_money($s_txn[0]->cost_of_acquisition,2); } else { echo '0'; } } else { echo '0'; } ?>" />
                                        <input type="hidden" class="form-control format_number" name="profit_loss" id="profit_loss" placeholder="Enter Here"  value="<?php if(isset($s_txn)) { if(count($s_txn)>0) { echo format_money($s_txn[0]->profit_loss,2); } else { echo '0'; } } else { echo '0'; } ?>" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                </div>
                            ...
                            <div id="repeatbuyer">
                                ...
                                <div id="repeat_buyer_<?php echo $j+1; ?>" class="row clearfix">
                                    <div class="col-md-5">
                                        <div class="form-group form-group-default form-group-default-select2">
                                            ...
                                            <select id="buyer_name_<?php echo $j+1; ?>" name="buyername[]" class="form-control buyer full-width" data-error="#err_buyer_name_<?php echo $j+1; ?>" data-placeholder="Select" data-init-plugin="select2">
                                                <option value="">Select</option>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input type="text" id="sharepercent_<?php echo $j+1; ?>" name="sharepercent[]" class="form-control" placeholder="Enter Here" value="<?php if(isset($s_buyer[$j]->share_percent)){ echo format_money($s_buyer[$j]->share_percent,2); } else { echo ''; }?>"/>
                                        </div>
                                    </div>
                                ...
                                <div id="repeat_buyer_<?php echo $j+1; ?>" class="row clearfix">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group form-group-default">
                                            <label>% of buyer</label>
                                            <input type="text" id="sharepercent_<?php echo $j+1; ?>" name="sharepercent[]" class="form-control" placeholder="Enter Here" value=""/>
                                        </div>
                                    </div>
                                    <div class="delete delete_row" id="repeat_buyer_<?php echo $j+1; ?>_delete"><i class="fa fa-trash" aria-hidden="true"></i></div>
                                </div>
                        ...
                        <div class="a">
                            ...
                            <button type="button" class="btn btn-default-info" data-toggle="modal" data-target="#myModal" onclick="opentable(); return false;">Schedule</button>
                                            ...
                                            <div class="col-md-12" id="import_schedule">
                                                <table class="view_table addschedule">
                                                    ...
                                                    <tbody id="schedule_table">
                                                        ...
                                                        <td><input type="text" name="sch_date[]" class="form-control datepicker" value="<?php echo $event_date;?>" style="border:none; text-align:left; background:#ffffff; color:rgb(44, 44, 44)!important;"/></td>
                                                        ...
                                                        <td class="form-group-default-select2">
                                                            <select name="sch_tax_<?php echo $schedule_id;?>[]" multiple class="form-control full-width" data-placeholder="Select" data-init-plugin="select2">
                                                            <?php $schedule_id++;
                    ...
                    <p class="div_heading p-t-20"><b>Remark</b></p>
