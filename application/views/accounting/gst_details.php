					...
					<div class="card card-transparent container-fixed-lg bg-white contact_card m-t-30" style="background:transparent;">
						...
						<div class="col-md-9">
							<div class="row clearfix" >
								<div class="col-md-12">
										<form action="<?php echo base_url(); ?>index.php/accounting/getGst" method="POST" style="display:none"></form>
										<div class="row clearfix" >
										...
										<div class="col-md-8">
											<form action="<?php echo base_url(); ?>index.php/accounting/getGst" method="POST">
										...
										<div class="col-md-2">
												<a href="<?=base_url('index.php/accounting/getGst');?>" target="_self"><span class="btn btn-default-danger">Reset</span></a>
										...
										<div class="row clearfix">
											<div class="col-md-12">
												<table id="example5" class="table table-bordered table-striped">
													<thead>
														<tr class="p-receipts">
															<th colspan="11">Receipts For GST</th>
														</tr>
														<tr>
															<th>Due</th>
															<th>Category</th>
													...
													<tbody>
														...
														<tr class="">
															...
															<td class="text-right"><?php echo format_money($bankentry[$i]['tax_amount'],2); ?></td>
										...
										<div class="row clearfix">
											<div class="col-md-12">
												<table id="example6" class="table table-bordered table-striped">
													<thead>
														<tr class="p-receipts">
															<th colspan="11">Payments For GST</th>
														</tr>
															<th>Due</th>
															<th>Category</th>
															<th>Person</th>
