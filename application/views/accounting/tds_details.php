								...
								<div class="col-md-12">
										...
										<div class="row clearfix">
												...
												<div class="col-md-12">
													<table id="example5" class="table table-bordered table-striped">
														...
														<tbody>
															...
															<tr class="">
																...
																{
																?>
																<td style="width:20px!important;"><input type="checkbox" name="accounting_id[]" value="<?php echo $bankentry[$i]['accounting_id']; ?>" /></td>
													...
													<a data-target="#tdsbank-modal1" data-toggle="modal" class="btn btn-success pull-right submit-form">Mark As Received</a>
														...
														<div class="row clearfix ">
															<div class="col-md-6 ">
																<div class="form-group form-group-default">
																	...
																	<input type="text" class="form-control " id="cheq_no" name="cheq_no" value=""/>
																</div>
															</div>
														</div>
													</div>
										...
										<div class="row clearfix">
												...
												<div class="col-md-12">
													<table id="example6" class="table table-bordered table-striped">
														...
														<br>
														<a data-target="#tdsbank-modal" data-toggle="modal" class="btn btn-success pull-right submit-form"> Mark As Paid </a>
