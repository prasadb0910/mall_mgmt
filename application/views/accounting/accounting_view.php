						...
						<div class="col-md-12" style="padding-left: 0;">
							<div class=" container-fluid p-t-20 container-fixed-lg bg-white">
								<div class="card card-transparent">
									...
									<div class="row clearfix">
										   <table id="example4" class="table table-bordered table-striped " style="overflow-x:scroll">
											<thead>
												<tr>
													<th >Transaction</th>
													...
													<th > <?php if($bl_other_schedue=='true') { echo 'display: none;'; } ?>Invoice no</th>
													...
													<th class="pay_now"><?php if($type=='receipt' || $type=='income') echo 'Received'; else echo 'Paid'; ?> Till Date</th>
													<th style="display: none;">Pending</th>
													<th class="pay_now">Less: TDS</th>
													<th class="pay_now"><?php if($type=='receipt' || $type=='income') echo 'Received'; else echo 'Payment'; ?> Amount</th>
													...
													<th class="pay_now">Outstanding</th>
												</tr>
											</thead>
