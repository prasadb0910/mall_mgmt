...
<script src="<?php echo base_url(); ?>assets/plugins/jquery-actual/jquery.actual.min.js" type="text/javascript"></script>
...
<!--<script src="<?php //echo base_url(); ?>assets/plugins/bootstrap3-wysihtml5/bootstrap3-wysihtml5.all.min.js" type="text/javascript"></script> -->
...
<script src="<?php echo base_url(); ?>js/plugins/bootstrap/bootstrap-file-input.js"></script>
...
<script src="<?php echo base_url(); ?>assets/js/append.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>css/logout/popModal.js"></script>
<script src="<?php echo base_url(); ?>js/menu_lock.js"></script>
